...
function NotificationListener({ userId }: { userId: string }) {
  ...
  useEffect(() => {
    ...
    const handleProfileUpdate = (data: any) => {
      // Always try to request permission if not granted
      if (window.Notification) {
        if (Notification.permission === "granted") {
          new Notification(data.title || "Profile Updated", {
            body: data.message || "Your profile was updated successfully.",
          });
            ...
            if (permission === "granted") {
              ...
              alert(
                `${data.title || "Profile Updated"}: ${
                  data.message || "Your profile was updated successfully."
                }`
              );
            }
          });
